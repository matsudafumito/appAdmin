...
class AdminShowAccountInfo : AppCompatActivity() {
    ...
    private var client = GetSelfInfoWsClient(this, uri)
    ...
    override fun onResume() {
        ...
        val getInfoRequest = client.createJsonrpcReq("getInfo/admin/basic", getUserInfoId, getInfoParams)
    ...
    override fun onRestart() {
        super.onRestart()
        client = GetSelfInfoWsClient(this, uri)
    }
...
class GetSelfInfoWsClient(private val activity: Activity, uri: URI) : WsClient(uri){
    var userId: Int = -1
    var userName = ""
    var birthday = ""
    var gender = ""
    ...
    override fun onMessage(message: String?) {
        ...
        if(resId == AdminShowAccountInfo.getUserInfoId){
